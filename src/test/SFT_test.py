...
# ==== 1) 配置这里 ====
ADAPTER_DIR = "D:/postgradute_Learning/paper/exam/GKD/runs/sft-qwen3b"  # ← 换成你的 LoRA 目录
PROMPT = "Based on the function description and the code snippet below, please generate a comprehensive set of detailed test cases that cover typical usage, edge cases, and potential error conditions.\n\nFunction Description:\nSumming values in a dictionary.\n\n    Parameters\n    ----------\n    dictTotal : TYPE\n        DESCRIPTION.\n\n    Returns\n    -------\n    TYPE\n        DESCRIPTION.\n\nCode Under Test:\ndef SumTotals(dictTotal):\n    \n    \n    totalVal = 0.0\n    for keyVal in dictTotal.keys():\n        for keyVal2 in dictTotal[keyVal].keys():\n            totalVal += dictTotal[keyVal][keyVal2]\n    \n    return round(totalVal, 2)\n\n"
MAX_NEW_TOKENS = 1024
TEMPERATURE = 0.7
TOP_P = 0.9
